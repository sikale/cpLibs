...
CSFML_AUDIO_API sfBool sfSoundBuffer_loadFromSamples(sfSoundBuffer* soundBuffer, const sfInt16* samples, sfUint64 sampleCount, unsigned int channelCount, unsigned int sampleRate);
